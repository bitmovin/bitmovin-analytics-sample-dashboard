...
class StartupDelayByTechGraph extends Component {
  ...
  componentDidMount () {
    ...
    startupDelay.videoStartupDelayByStreamFormat(this.props.apiKey, ranges.thisWeek).then(results => {
  ...
  render () {
    return <Card title="Startup Delay by Stream Format" width={this.props.width || {md: 12, sm: 12, xd: 12}} cardHeight="auto">
...
export default connect(mapStateToProps)(StartupDelayByTechGraph);
