...
class ErrorsForVideo extends Component {
  static propTypes = {
  ...
  async loadData({ api, video }) {
    ...
    const result = await stats.fetchVideoHeatMapErrors(api, video, range);
...
export default connect(mapStateToProps)(ErrorsForVideo);
