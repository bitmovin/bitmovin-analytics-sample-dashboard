...
class TimeFrameDialog extends Component {
  ...
  render () {
    const yesterdayMidnight = moment.utc().endOf('day').toDate();
    const predefinedRanges = [
      ...
      { name: 'Last 24 Hours', start: moment.utc().subtract(1, 'day').startOf('hour').toDate(), end: moment.utc().endOf('hour').toDate() },
