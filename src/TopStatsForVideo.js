    ...
    <div>
      <div className="row tile_count">
        ...
        <TopStatMetric
          ...
          icon="user"
          fetchData={() =>
            topstats.fetchTotalImpressionsThisWeek(apiKey, primaryRange, secondaryRange, baseQuery, videoId)
          }
        />
        <TopStatMetric
          format="pct"
          ...
          compareUserBase
          fetchData={() =>
            topstats.fetchErrorPercentageThisWeek(apiKey, primaryRange, secondaryRange, baseQuery, videoId)
          }
        />
        <TopStatMetric
          format="pct"
          ...
          inverse
          fetchData={() =>
            topstats.fetchRebufferPercentageThisWeek(apiKey, primaryRange, secondaryRange, baseQuery, videoId)
          }
        />
        <TopStatMetric
          format="ms"
          ...
          compareUserBase
          fetchData={() =>
            topstats.fetchAverageStartupDelayThisWeek(apiKey, primaryRange, secondaryRange, baseQuery, videoId)
          }
        />
        <TopStatMetric
          format="pct"
