...
class ApiKeyConfiguration extends Component {
  ...
  render() {
    ...
    const footer = (
      <button onClick={::this.submitClicked} className="btn btn-simple btn-wd btn-lg" role="button">
        Continue
      </button>
    );
    const invalidText = !this.props.invalid ? null : (
      <p className="text-danger">Your Credentials seem to be invalid. Please try again</p>
    );
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <Card
            width={{md: 4, sm: 6, xs: 12}}
            title="Please enter your credentials"
            className="col-md-offset-4 col-sm-offset-3 card-login"
            login={true}
            cardHeight="auto"
            footer={footer}
            centerHeader={true}
