...
class CountGraph extends Component {
      ...
      yAxis : {
        ...
        title    : {
          text: 'Impressions'
			...
			series: this.formatSeries().map((x) => { return { data: x }; }),
	...
	render () {
		return (<Card title={this.props.title} width={this.props.width || { md:12, sm: 12, xs: 12}} fixedHeight={false} cardHeight="auto">
