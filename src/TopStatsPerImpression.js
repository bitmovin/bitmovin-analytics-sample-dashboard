    ...
    return (
      <div>
        <div className="row tile_count">
          ...
          <TopStatImpressionMetric
            title="Time spent rebuffering"
            metric={this.props.metrics.rebuffering}
            icon="spinner"
            inverse={true}
          />
          <TopStatImpressionMetric
            title="Delay"
            metric={this.props.metrics.startupTime}
            icon="hourglass-half"
            inverse={true}
          />
          <TopStatImpressionMetric
            title="Average Bitrate"
            metric={this.props.metrics.avgBitrate}
            icon="wifi"
            inverse={false}
          />
        </div>
